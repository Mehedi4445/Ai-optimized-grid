...
:root{
  --gold:#D4870A;--amber:#CC5500;--blue:#0066CC;--navy:#FFFFFF;
  --panel:#F5F7FA;--card:#FFFFFF;--border:#D0D7E2;--text:#1A1A2E;
  --muted:#5A6A7E;--green:#1A8C4E;--red:#CC1A33;
}
html,body,[data-testid="stAppViewContainer"]{
  background:var(--navy)!important;font-family:'Arial',sans-serif;color:var(--text);
}
...
.stButton>button:hover{transform:translateY(-2px);box-shadow:0 8px 20px rgba(212,135,10,0.35)!important;}
.stTextInput>div>div>input,.stNumberInput>div>div>input{
  background:var(--card)!important;border:1px solid var(--border)!important;
  color:var(--text)!important;border-radius:8px!important;font-family:'Arial',sans-serif!important;
}
.stSelectbox>div>div{background:#FFFFFF!important;border:1px solid #D0D7E2!important;}
h1,h2,h3{font-family:'Arial',sans-serif!important;color:#D4870A!important;}
...
.mval{font-family:'Arial',sans-serif;font-size:2rem;font-weight:900;color:var(--gold);}
.mlabel{font-size:0.75rem;color:var(--muted);letter-spacing:2px;text-transform:uppercase;margin-top:0.2rem;}
.section{font-family:'Arial',sans-serif;font-size:0.9rem;color:#0066CC;
  letter-spacing:2px;border-bottom:1px solid var(--border);padding-bottom:0.5rem;margin:1.5rem 0 1rem;}
.status-bar{background:#FFFFFF;border:1px solid #D0D7E2;box-shadow:0 2px 8px rgba(0,0,0,0.06);border-radius:10px;
...
.ai-badge{display:inline-block;background:rgba(0,102,204,0.10);border:1px solid rgba(0,102,204,0.20);
...
.priority-card{background:#FFFFFF;border:1px solid #D0D7E2;border-radius:14px;padding:1.2rem;text-align:center;border-left:4px solid;box-shadow:0 2px 8px rgba(0,0,0,0.05);}
.login-title{font-family:'Arial',sans-serif;font-size:2.6rem;font-weight:900;
  color:#D4870A;letter-spacing:3px;}
.login-card{background:#FFFFFF;border:1px solid #D0D7E2;border-radius:16px;
  padding:2.5rem;max-width:420px;margin:1.5rem auto;box-shadow:0 20px 60px rgba(0,0,0,0.08);}
.demo-creds{background:rgba(0,102,204,0.05);border:1px solid rgba(0,102,204,0.15);
